...
async function updateTrafficMarkers() {
  ...
  situations.forEach(sit => {
    ...
    if (sit.SituationType?.includes("Accident")) iconUrl = "icons/accident.png";
    if (sit.SituationType?.includes("RoadWork")) iconUrl = "icons/roadwork.png";
    if (sit.SituationType?.includes("QueueingTraffic")) iconUrl = "icons/trafficjam.png";
    ...
    marker.bindPopup(`
      <b>${sit.SituationType?.join(", ") || "Okänd händelse"}</b><br>
